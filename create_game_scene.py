...
with open('/Users/bytedance/Documents/trae_projects/cocos_cli/my_test_game/assets/scenes/GameScene.fire', 'w') as f:
    json.dump(scene_data, f, indent=2)

print("GameScene.fire generated successfully.")
